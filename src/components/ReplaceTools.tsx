      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-[1fr_auto_1fr] gap-6 md:gap-8 items-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="rounded-2xl md:rounded-3xl bg-black/40 border border-white/[0.08] p-6 md:p-8"
          >
            <p className="font-poppins font-bold text-base md:text-lg text-zinc-400 mb-5 md:mb-6">
              Várias assinaturas:
            </p>
            ...
            <div className="space-y-3 md:space-y-4">
              {scattered.map((tool, i) => (
                ...
                >
                  ...
                  <span className="text-sm md:text-base text-zinc-400">{tool}</span>
                </motion.div>
              ))}
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.5 }}
            className="rounded-2xl md:rounded-3xl bg-black/40 border border-accent/20 p-6 md:p-8"
            style={{
              boxShadow: "0 20px 80px rgba(0,0,0,0.4), 0 0 60px rgba(255,170,0,0.06)",
            }}
          >
            <p className="font-poppins font-bold text-base md:text-lg text-white mb-5 md:mb-6">
              Calango Studio:
            </p>
